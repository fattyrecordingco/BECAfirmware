...
void SynthEngine::presetDefaults(uint8_t index, SynthParams& out) {
  ...
  switch (idx) {
    ...
    case 10:  // Amber Bloom Pad
      ...
      out.release = 2.20f;
      out.filterType = SYNTH_FILTER_LOWPASS;
      out.cutoffHz = 2600.0f;
      out.resonance = 0.60f;
      out.reverb = 0.40f;
      out.delayMs = 380.0f;
      out.delayFeedback = 0.29f;
      out.delayMix = 0.18f;
      out.distDrive = 0.02f;
      out.master = 0.50f;
      out.detuneCents = 3.2f;
      out.gainTrim = 0.82f;
      break;
    ...
    case 12:  // Velvet Hollow
      ...
      out.release = 1.10f;
      out.filterType = SYNTH_FILTER_BANDPASS;
      out.cutoffHz = 1450.0f;
      out.resonance = 1.10f;
      out.reverb = 0.26f;
      out.delayMs = 230.0f;
      out.delayFeedback = 0.19f;
      out.delayMix = 0.14f;
      out.distDrive = 0.05f;
      out.master = 0.52f;
      out.detuneCents = 2.4f;
      out.gainTrim = 0.84f;
      break;
    case 13:  // Moon Tape Choir
      ...
      out.reverb = 0.44f;
      out.delayMs = 420.0f;
      out.delayFeedback = 0.32f;
      out.delayMix = 0.22f;
      out.distDrive = 0.02f;
      out.master = 0.48f;
      out.detuneCents = 4.2f;
      out.gainTrim = 0.78f;
      break;
