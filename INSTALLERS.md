...
- `0.1.4` (`apps/beca-setup/src-tauri/tauri.conf.json`)

If an OS folder is empty, pull latest published setup release assets into this mirror:

```powershell
powershell -ExecutionPolicy Bypass -File tools/sync_setup_installers.ps1 -Tag setup-v0.1.4 -Clean -RequireAllPlatforms
```
