# 1 "C:\\Users\\Asus\\AppData\\Local\\Temp\\tmp3jx9oz2o"
#include <Arduino.h>
...
#define PLANT1_PIN 34
#define PLANT2_PIN 34
...
const uint32_t BLE_KICK_INTERVAL_MS = 2500;
...
volatile float gScopePlant = 0.0f;


volatile uint32_t gHoldUntilMs = 0;
...
static const uint32_t RUNTIME_STATE_MAGIC = 0x42454341UL;
...
static const uint8_t DR_CHH = 42;
static const uint8_t DR_OHH = 46;
...
static inline uint8_t clampToC1B8(uint8_t midi) {
  if (midi < 24) return 24;
  if (midi > 119) return 119;
  return midi;
}
...
static inline void saveRuntimeStateNow() {
  ...
  prefs.putUChar("midimode", snap.outputmode == OUTPUT_SERIAL ? 1 : 0);
  prefs.end();
...
void setup();
void loop();
#line 922 "C:/Users/Asus/OneDrive/Documents/Fatty Recording Co/BECA/BECAv1.0.1/Codes/BECAfinalsv02/BECAfinalsv02.ino"
void fxGradientFlow() {
...
const uint32_t PLANT_INTERVAL_MS = 8;
const uint32_t LED_INTERVAL_MS = 34;
const uint32_t SSE_SCOPE_MS = 100;
const uint32_t SSE_NOTE_MS = 72;
const uint32_t SSE_DRUM_MS = 66;
