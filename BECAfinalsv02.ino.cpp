# 1 "C:\\Users\\Asus\\AppData\\Local\\Temp\\tmp1hogq4u8"
#include <Arduino.h>
...
void setup();
void loop();
#line 668 "C:/Users/Asus/OneDrive/Documents/Fatty Recording Co/BECA/BECAv1.0.1/Codes/BECAfinalsv02/BECAfinalsv02.ino"
void fxGradientFlow() {
...
static inline void saveOutputModePref() {
  ...
  prefs.putUChar("midimode", outputModeIsSerial() ? 1 : 0);
  prefs.end();
}
...
const uint32_t SSE_NOTE_MS = 60;
const uint32_t SSE_DRUM_MS = 50;
