...
const required = ["index.html", "app.css", "app.js", "protocol.js", "webusb-serial.js", "manifest.webmanifest", "service-worker.js", "icons/icon.svg", "icons/wordmark.svg", "icons/icon-192.png", "icons/icon-512.png"];
